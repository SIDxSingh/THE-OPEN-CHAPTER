        ...
        <div className="footer-content">
          <div className="footer-brand">
            ...
            <div className="social-icons mt-3">
              <a href="https://www.instagram.com/the_open_chapter_x/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><InstagramIcon size={20} /></a>
              <a href="https://www.linkedin.com/in/sidd06/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><LinkedinIcon size={20} /></a>
            </div>
          </div>
